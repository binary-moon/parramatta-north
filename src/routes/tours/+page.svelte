<script lang="ts">
  ...
  $: filteredTours =
    $activeFilter === "All"
      ? tours
      : tours.filter((tour) => tour.tags.includes($activeFilter));
</script>

<div class="flex flex-col gap-6 pb-6 relative">
  <Filter {filterOptions} />
  <div class="px-6">
    Take a self-guided digital tour full of compelling stories and features.
  </div>
  ...
  <img
    ...
    alt="Promo decoration"
    class="absolute top-[470px] left-0"
  />
</div>
